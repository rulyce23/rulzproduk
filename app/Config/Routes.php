...
$routes->group('', ['namespace' => 'App\Controllers'], function($routes) {
  ...
  //customer
      ...
      $routes->get('customer', 'Auth\CustomerController::customer', ['as' => 'customer']); // new
      $routes->get('customer/edit/(:num)', 'Auth\CustomerController::edit'); // new
      $routes->post('customer/update-customer', 'Auth\CustomerController::update'); // new
      $routes->get('customer/delete/(:num)', 'Auth\CustomerController::delete'); // new
      $routes->post('customer/create-customer', 'Auth\CustomerController::store');
    
  //barang

  $routes->get('barang', 'Auth\BarangController::barang', ['as' => 'barang']); // new
  $routes->get('barang/edit/(:num)', 'Auth\BarangController::edit'); // new
  $routes->post('barang/update-barang', 'Auth\BarangController::update'); // new
  $routes->get('barang/delete/(:num)', 'Auth\BarangController::delete'); // new
  $routes->post('barang/create-barang', 'Auth\BarangController::store');
