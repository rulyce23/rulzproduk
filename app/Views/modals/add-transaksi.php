...
`  <!-- Sidebar - Brand -->
        <a class="sidebar-brand d-flex align-items-center justify-content-center">
            <div class="sidebar-brand-icon rotate-n-15">
                <img src="/../img/rullz.jpg " height="65" width="65" style="border-radius: 50%; margin-top:5px;"></img>
            </div>
                ...
                <table id="xakun" class="table table-bordered table-hover table-striped">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><?php echo $d2['jenis'] ?></td>
                            <td>
                            <button class="btn btn-success btn-xs" onclick="pilih_barang2('<?php echo $d2['id'] ?>', '<?php echo $d2['kode'] ?>', '<?php echo $d2['nama'] ?>')" data-dismiss="modal">PILIH</button>
                               </td>
                        </tr>
                        <?php } ?>
                    </tbody>
